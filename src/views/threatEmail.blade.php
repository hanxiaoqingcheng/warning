...
<table style="width: 640px; margin: 50px auto; background: #fff; font-family: 'Microsoft Yahei'; border-collapse: collapse; border: 1px solid #ccc;" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td>
            ...
            <div style="font-size: 24px; line-height: 36px; color: #333; padding: 0 40px 30px 40px;">您监控的关键字<b>「{{$warning->keyword}}」</b>,有<b style="color: #F42020;">{{$warning->count}}个</b>新增威胁情报，请前往<a style="color: #207CF6; text-decoration: underline;" href="https://scan.juhe.cn/">https://scan.juhe.cn/</a>查看</div>
        </td>
    </tr>
    <tr>
